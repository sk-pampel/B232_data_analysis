...
boStates = [
    ...
    {"L":1, "|Lambda|":1, "S":1, "I_BO":'g',"kappa_BO":'' },
    {"L":1, "|Lambda|":1, "S":1, "I_BO":'u',"kappa_BO":''  },
    {"L":1, "|Lambda|":1, "S":0, "I_BO":'g',"kappa_BO":''  },
    {"L":1, "|Lambda|":1, "S":0, "I_BO":'u',"kappa_BO":''  },
]
...
def get_H_BO(C3, Rv, bo_basis):
    ...
    for num, state in enumerate(bo_basis):
        I_BO = 0 if state["I_BO"]=="g" else 1
        L_ = state["L"]
        H_BO[num,num] = (2*(C3/Rv**3)*float((-1))**(state[lambdaKey]+state['S']+I_BO)
